...
const StudentForm = ({
  ...
  useEffect(() => {
    if (state.success) {
      toast(`L'élève a bien été ${type === "create" ? "créé" : "mis à jour"}!`);
      setOpen(false);
      router.refresh();
    }
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      <h1 className="text-xl font-semibold">
        {type === "create" ? "Créer un nouvel élève" : "Modifier un élève"}
      </h1>
