...
export const examSchema = z.object({
  ...
  startTime: z.coerce.date({ message: "Le temps de debut est obligatoire!" }),
  endTime: z.coerce.date({ message: "Le temps de fin est obligatoire!" }),
...
export const parentSchema = z.object({
  ...
  address: z.string(),
  img: z.string().optional(),
  relationship: z.string().min(1, { message: "La relation avec l'élève est obligatoire!" }),
  bloodType: z.string().min(1, { message: "Le type de sang est obligatoire!" }),
  birthday: z.coerce.date({ message: "La date de naissance est obligatoire!" }),
  sex: z.enum(["MALE", "FEMALE"], { message: "Le sexe est obligatoire!" }),
  children: z.array(z.string()).optional(), // student ids
});
