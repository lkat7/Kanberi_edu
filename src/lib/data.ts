...
export const calendarEvents = [
  {
    title: "Mathématiques",
    allDay: false,
    start: new Date(2025, 0, 27, 8, 0),
    end: new Date(2025, 0, 27, 8, 45),
  },
  {
    title: "Anglais",
    allDay: false,
    start: new Date(2025, 0, 27, 9, 0),
    end: new Date(2025, 0, 27, 9, 45),
  },
  {
    title: "Biologie",
    allDay: false,
    start: new Date(2025, 0, 27, 10, 0),
    end: new Date(2025, 0, 27, 10, 45),
  },
  {
    title: "Physique",
    allDay: false,
    start: new Date(2025, 0, 27, 11, 0),
    end: new Date(2025, 0, 27, 11, 45),
  },
  {
    title: "Chimie",
    allDay: false,
    start: new Date(2025, 0, 27, 13, 0),
    end: new Date(2025, 0, 27, 13, 45),
  },
  {
    title: "Histoire",
    allDay: false,
    start: new Date(2025, 0, 27, 14, 0),
    end: new Date(2025, 0, 27, 14, 45),
  },
  ...Array.from({ length: 4 }, (_, i) => [
    {
      title: "Mathss",
      allDay: false,
      start: new Date(2025, 0, 28 + i, 8, 0),
      end: new Date(2025, 0, 28 + i, 8, 45),
    },
    {
      title: "Anglais",
      allDay: false,
      start: new Date(2025, 0, 28 + i, 9, 0),
      end: new Date(2025, 0, 28 + i, 9, 45),
    },
    {
      title: "Biologie",
      allDay: false,
      start: new Date(2025, 0, 28 + i, 10, 0),
      end: new Date(2025, 0, 28 + i, 10, 45),
    },
    {
      title: "Physique",
      allDay: false,
      start: new Date(2025, 0, 28 + i, 11, 0),
      end: new Date(2025, 0, 28 + i, 11, 45),
    },
    {
      title: "Chimie",
      allDay: false,
      start: new Date(2025, 0, 28 + i, 13, 0),
      end: new Date(2025, 0, 28 + i, 13, 45),
    },
    {
      title: "Histoire",
      allDay: false,
      start: new Date(2025, 0, 28 + i, 14, 0),
      end: new Date(2025, 0, 28 + i, 14, 45),
    },
  ]).flat(),
];
